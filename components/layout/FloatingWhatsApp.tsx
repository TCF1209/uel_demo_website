...
export function FloatingWhatsApp() {
  return (
    <a
      ...
      className="fixed z-50 grid place-items-center rounded-full bg-whatsapp shadow-lg shadow-whatsapp/30 ring-1 ring-whatsapp/40 transition-transform hover:scale-105 active:scale-95
        bottom-[calc(env(safe-area-inset-bottom)+24px)] right-6
        size-14 md:size-16"
    >
      <svg
        viewBox="0 0 24 24"
